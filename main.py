...
def diskmanage():
    ...
    part1=input(" -> ")
    print("    *Ingrese nombre de particion ROOT:")
    part2=input(" -> ")
    print("    *Ingrese nombre de particion HOME:")
    part3=input(" -> ")
    ...
    os.system(f"mkfs.ext4 /dev/{part3}")
    os.system(f"mkswap /dev/{part4}")
    os.system(f"swapon /dev/{part4}")

    os.system(f"mount /dev/{part2} /mnt/")
    os.system("mkdir -p /mnt/efi")
    os.system("mkdir -p /mnt/home")
    os.system(f"mount /dev/{part1} /mnt/efi")
    os.system(f"mount /dev/{part3} /mnt/home")
